...
class ItemControllerTest {
    ...
    @Test
    void shouldFailAddWhenBookerIdIsNegative() throws Exception {
        Mockito
                .when(service.addNewItem(anyLong(), any(InputItemDto.class)))
                .thenReturn(inputItemDto);
    ...
    @Test
    void shouldFailUpdateItemWhenNegativeItemIdOrNegativeUserId() throws Exception {
        Mockito
                .when(service.updateItem(anyLong(), anyLong(), any(InputItemDto.class)))
                .thenReturn(updateInputItemDto);
    ...
    @Test
    void shouldFailGetItemWhenNegativeItemIdOrNegativeUserId() throws Exception {
        Mockito
                .when(service.getItem(anyLong(), anyLong()))
                .thenReturn(itemDto);
    ...
    @Test
    void shouldFailAddCommentWhenNegativeItemIdOrNegativeUserId() throws Exception {
        Mockito
                .when(service.addComment(anyLong(), anyLong(), any(CommentDto.class)))
                .thenReturn(commentDto);

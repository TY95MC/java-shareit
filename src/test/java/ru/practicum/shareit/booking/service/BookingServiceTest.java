...
class BookingServiceTest {
    ...
    @Test
    void shouldFailGetUserBookingsWithWrongUserIdOrWrongState() {
        Exception e = assertThrows(EntityValidationException.class,
                () -> bookingService.getUserBookings(bookerDto.getId(), "wrong_state", 0, 10));
        assertThat(e.getMessage(), equalTo("Unknown state: wrong_state"));
    ...
    @Test
    void shouldFailGetBookingsByOwnerWithWrongUserIdOrWrongState() {
        Exception e = assertThrows(EntityValidationException.class,
                () -> bookingService.getUserBookings(ownerDto.getId(), "wrong_state", 0, 10));
        assertThat(e.getMessage(), equalTo("Unknown state: wrong_state"));

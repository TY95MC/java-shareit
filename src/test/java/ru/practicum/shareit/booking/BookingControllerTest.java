...
class BookingControllerTest {
    ...
    @Test
    void shouldReturnBadRequestWhenWrongStartTimeAndServerErrorWhenBookerIdIsNegative() throws Exception {
        Mockito
                .when(bookingService.create(anyLong(), any(InputBookingDto.class)))
                .thenReturn(bookingDto);
        inputBookingDto.setStart(LocalDateTime.now().minusHours(1));
        ...
        inputBookingDto.setStart(LocalDateTime.now().plusMinutes(10));
        bookerDto.setId(-1L);
